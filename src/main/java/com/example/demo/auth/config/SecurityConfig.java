...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFilter jwtSuccessHandler;
	private OAuthSuccessHandler oAuthSuccessHandler;

    public SecurityConfig(UserService userService,JwtAuthenticationFilter jwtSuccessHandler, OAuthSuccessHandler oAuthSuccessHandler) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/user/hi","/api/category/**","/api/product/**","/api/cart/**").hasAnyRole(AppConstants.ROLE_BUYER,AppConstants.ROLE_SELLER)
...
//                    .defaultSuccessUrl("/home", true)
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.List.of("http://localhost:3000", "http://localhost:4200", "http://localhost:5173", "http://localhost:8081"));
